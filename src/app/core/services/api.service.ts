...
export class PresenceService {
    ...
    getPresentUsersForDate(date: Date): Observable<User[] | null> {
        let url_ = this.baseUrl + "/api/Presence/date?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPresentUsersForDate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPresentUsersForDate(<any>response_);
                } catch (e) {
    ...
    protected processGetPresentUsersForDate(response: HttpResponseBase): Observable<User[] | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
